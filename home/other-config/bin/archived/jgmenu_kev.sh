...
(
	...
	printf "^tag(2)\n"
	printf "rc.fish,kitty -e nvim ~/.config/fish/conf.d/rc.fish\n"
	printf "i3.conf,kitty -e nvim ~/.config/i3/config\n"
	printf "polybar,kitty -e nvim ~/.config/polybar/config.ini\n"
	printf "polybar,kitty -e sudo nvim /etc/nixos/configuration.nix\n"
	printf "Edit Menu,kitty -e nvim ~/bin/jgmenu_kev.sh\n"
	printf "^tag(3)\n"
