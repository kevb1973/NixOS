...
alias edit-aliases="nvim ~/NixOS/home/dot-config/fish/conf.d/aliases-abbrs.fish && source ~/NixOS/home/dots/fish/conf.d/aliases-abbrs.fish"
alias conf="nvim ~/NixOS/"
alias dg="nix-collect-garbage -d"
...
alias sdg="sudo nix-collect-garbage -d"
alias sg="nh os info"
alias sn="nh search packages -l 100"
alias sno="nh search options -l 100"
alias snp="nh search prs"
alias sni="nh search issues"
alias storebin="nix-store -q --roots (which $argv)"
alias ugc="nix store gc -v"
alias ug="nix-env --list-generations"
alias up="nh os switch --update --commit-lock-file --ask ~/NixOS && changes"
...
abbr -a --set-cursor='%' -- npg 'nix profile add github:%/'
abbr -a --set-cursor='%' -- npi 'nix profile add nixpkgs#%'
abbr -a --set-cursor='%' -- npis 'nix profile add nixpkgs/release-24.11#%'
abbr -a --set-cursor='%' -- nr 'nix run nixpkgs#%'
abbr -a --set-cursor='%' -- ns 'nix shell nixpkgs#% -c fish'
abbr -a --set-cursor='%' -- pin 'nix profile add nixpkgs/(nixos-version --hash)#%'
abbr -a -- scu 'systemctl --user'
abbr -a --set-cursor='%' -- snn "nix-search -d -r --name '%'"
# abbr -a --set-cursor='%' -- snp "nix-search -d -r --program '%'"
abbr -a --set-cursor='%' -- snd "nix-search -d -r --query-string='package_description:('%')'"
abbr -a --set-cursor='%' -- ytm 'yt-dlp --add-metadata -x --audio-format mp3 --audio-quality 320k %'
